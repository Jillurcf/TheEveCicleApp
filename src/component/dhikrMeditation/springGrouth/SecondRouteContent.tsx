...
const SecondRouteContent = (props: Props) => {
    ...
    const data = [
        {
            ...
            , image: require('../../../assets/Imgages/Sanctum/Resource/DhikrAndMedition/springGrouth.png'),
    ...
    return (
        <View flex-1>
            <View style={{ backgroundColor: '#E8F6F6', padding: '4%' }}>
                <View style={{}}>
                    <LinearGradient
                        colors={[  '#FFFF3F00', '#55A630', ]} // Gradient colors (adjust as needed)
            ...
            <View style={tw``}>
                <FlatList
                    ...
                    renderItem={(item) => {
                        ...
                        return (
                            <TouchableOpacity
                                style={tw`flex-row gap-2 items-center justify-center,  ${playingId === item?.item?.id ? "bg-[#55A63012]" : ''} px-2 rounded-2xl mb-4`}
