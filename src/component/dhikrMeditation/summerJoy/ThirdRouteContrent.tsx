...
const ThirdRouteContent = (props: Props) => {
    ...
    const data = [
        {
            ...
            , image: require('../../../assets/Imgages/Sanctum/Resource/DhikrAndMedition/SummerJoy.png'),
    ...
    return (
        <ScrollView flex-1>
            <View style={{ backgroundColor: '#E8F6F6', padding: '4%' }}>
                <View style={{}}>
                    <LinearGradient
                        colors={[ '#FFEA0000', '#FFA200',]} // Gradient colors (adjust as needed)
            ...
            <View style={tw``}>
                <FlatList
                    ...
                    renderItem={(item) => {
                        ...
                        return (
                            <TouchableOpacity
                                style={tw`flex-row gap-2 items-center justify-center,  ${playingId === item?.item?.id ? "bg-[#FFA20112]" : ''} px-2 rounded-2xl mb-4`}
...
export default ThirdRouteContent
