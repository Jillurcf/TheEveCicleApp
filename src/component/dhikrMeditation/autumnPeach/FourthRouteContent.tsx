...
const FourthRouteContent = (props: Props) => {
    ...
    const data = [
        {
            ...
            , image: require('../../../assets/Imgages/Sanctum/Resource/DhikrAndMedition/autumnPeach.png'),
    ...
    return (
        <ScrollView flex-1>
            <View style={{ backgroundColor: '#E8F6F6', padding: '4%' }}>
                <View style={{}}>
                    <LinearGradient
                        colors={[  '#FFBA0800', "#D00000", ]} // Gradient colors (adjust as needed)
            ...
            <View style={tw``}>
                <FlatList
                    ...
                    renderItem={(item) => {
                        ...
                        return (
                            <TouchableOpacity
                                style={tw`flex-row gap-2 items-center justify-center,  ${playingId === item?.item?.id ? "bg-[#D0000012]" : ''} px-2 rounded-2xl mb-4`}
...
export default FourthRouteContent
