    ...
    return (
        <ScrollView flex-1>
            <View style={{ backgroundColor: '#E8F6F6', padding: '4%' }}>
                <View style={{}}>
                    <LinearGradient
                        colors={['#CAF0F800', '#00B4D8',]} // Gradient colors (adjust as needed)
            ...
            <View style={tw``}>
                <FlatList
                    ...
                    renderItem={(item) => {
                        ...
                        return (
                            <TouchableOpacity
                                style={tw`flex-row gap-2 items-center justify-center,  ${playingId === item?.item?.id ? "bg-[#01B4D812]" : ''} px-2 rounded-2xl mb-4`}
